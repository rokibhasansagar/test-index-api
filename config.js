...
const authConfig = {
    "siteName": "GDIndex API", // Website name
    "client_id": "889239504726-2thfla9p8k4tkuh29vrmlgbog1v82vse.apps.googleusercontent.com", // Client id from Google Cloud Console
    "client_secret": "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", // Client Secret from Google Cloud Console
    "refresh_token": "1//0gSpwU8_AnQABCgYIARAAGBASNwF-L9Irouvz7mA7e-bCrzrYMx8Ju9tZmXNfPYd0pzqjlV22zE-fD2rl_3tvLG-jbXqmLTTayrI", // Authorize token
    "service_account": false, // true if you're using Service Account instead of user account
    "service_account_json": randomserviceaccount, // don't touch this one
    "files_list_page_size": 100,
    "search_result_list_page_size": 100,
    "enable_cors_file_down": false,
    "cors_domain": "https://test-index-api.vercel.app",
...
const uiConfig = {
    "theme": "darkly", // switch between themes, default set to slate, select from https://github.com/rokibhasansagar/BhadooGDIndex#themes
    "version": "2.2.3", // don't touch this one. get latest code using generator at https://bhadoogen.phantomzone.workers.dev
    "api_url": "https://test-index-api-backend.fr3akyphantom.workers.dev",
